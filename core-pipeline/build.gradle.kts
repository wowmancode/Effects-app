...
android { namespace = "org.effectapp.pipeline"; compileSdk = 35; defaultConfig { minSdk = 24 }; compileOptions { sourceCompatibility = JavaVersion.VERSION_17; targetCompatibility = JavaVersion.VERSION_17 } }
